...
- Kotlin | Grammar | whenExpression | https://kotlinlang.org/grammar/#whenExpression
- Kotlin | Control flow: When expressions and statements
...
- Context-sensitive resolution
  https://github.com/Kotlin/KEEP/blob/improved-resolution-expected-type/proposals/context-sensitive-resolution.md
...
- Kotlin | Checks with is and !is operators
